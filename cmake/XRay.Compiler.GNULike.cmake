...
elseif (ANDROID)
    if (ANDROID_DEPS_DIR)
        ...
        set(OGG_INCLUDE_DIR "${ANDROID_DEPS_DIR}/include/ogg" CACHE PATH "")
        set(OGG_LIBRARY "${ANDROID_DEPS_DIR}/lib/libogg.a" CACHE FILEPATH "")
        set(VORBIS_INCLUDE_DIR "${ANDROID_DEPS_DIR}/include/vorbis" CACHE PATH "")
        set(VORBIS_LIBRARY "${ANDROID_DEPS_DIR}/lib/libvorbis.a" CACHE FILEPATH "")
        set(LZO_INCLUDE_DIR "${ANDROID_DEPS_DIR}/include/lzo" CACHE PATH "")
